//From SI the number of students N, and then N pairs of integers are read, where the first number is the students' points
// and the second is the max. points. Write a program where for each pair (points, max points)
// will print the student's success in percentage and his grade following these rules:
